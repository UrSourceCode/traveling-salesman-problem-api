...
def do_tsp():
    ...
    for i in range(0, len(input_json)):
        city_list.append(City.City(id=input_json[i]["id"], lon=input_json[i]["coordinate"][0], lat=input_json[i]["coordinate"][1]))
    ...
    [id_list, distance] = ga.genetic_algorithm(population=city_list, pop_size=100, elite_size=20, mutation_rate=0.01, generations=num_of_generation)
